  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> we're Akari
          </BigTitle>
          <Subtitle>Doing cloudy stuff for awesome companies.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Azure"
              link="https://www.portal.azure.com"
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            ...
            <a href="https://social">Link 1</a> &{' '}
            <a href="https://social">Link 2</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 by Tom Cox - Hosted on Azure{' '}
          <a href="https://github.com/Koxzi95">Github Repository</a>.
        </Footer>
      </Content>
